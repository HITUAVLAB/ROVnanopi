...
public:
	...
	// This does not destory the object until the thread has been terminated
	virtual ~Thread();
	...
	// Return true if the stop() method been called, false otherwise.
...
private:
    ...
    //some static variables for all thread objects
	static bool ourInitializedFlag;
    static void* threadproc(void* param);     // The C++ member function has a variable this, so it cannnot be used as a thread function,
                                              // Declear the member function as static to dismiss this pointer
